...
class Lyrics extends Component {
    ...
    componentDidMount(){
        ...
        .then(res => {
            ...
            return axios.get(`https://cors-anywhere.herokuapp.com/http://api.musixmatch.com/ws/1.1/album.tracks.get?track_id=${this.props.match.params.id}&apikey=${
                process.env.REACT_APP_MM_KEY}`)
        })
        .then(res => {
            console.log(res.data)
            // this.setState({album: res.data.message.body.track_list});
        })
